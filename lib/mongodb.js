...
MongoDB.prototype.create = function(model, data, options, callback) {
  ...
  this.execute(model, 'insertOne', data, Object.assign({safe: true}, options), function(err, result) {
    if (self.debug) {
...
MongoDB.prototype.save = function(model, data, options, callback) {
  ...
  this.execute(model, 'updateOne', {_id: oid}, {$set: data}, Object.assign({upsert: true}, options), function(err, result) {
    if (!err) {
...
MongoDB.prototype.destroy = function destroy(model, id, options, callback) {
  ...
  id = self.coerceId(model, id, options);
  this.execute(model, 'deleteOne', {_id: id}, options, function(err, result) {
    if (self.debug) {
...
MongoDB.prototype.all = function all(model, filter, options, callback) {
  ...
  if (fields) {
    ...
    this.execute(model, 'find', query, Object.assign(findOpts, options), processResponse);
  } else {
...
MongoDB.prototype.destroyAll = function destroyAll(
  ...
  this.execute(model, 'deleteMany', where || {}, options, function(err, info) {
...
MongoDB.prototype.count = function count(model, where, options, callback) {
  ...
  this.execute(model, method, where, options, function(err, count) {
    if (self.debug) {
...
MongoDB.prototype.update = MongoDB.prototype.updateAll = function updateAll(
  ...
  this.execute(
    ...
    where,
    data,
    Object.assign({upsert: false}, options),
    function(err, info) {
      if (err) return cb && cb(err);
...
function optimizedFindOrCreate(model, filter, data, options, callback) {
  ...
  this.collection(model).findOneAndUpdate(
    query,
    {$setOnInsert: data},
    Object.assign({projection: projection, sort: sort, upsert: true}, options),
    function(err, result) {
      if (self.debug) {
